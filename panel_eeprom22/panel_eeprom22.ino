...
void setup()
{
 ...
 WiFi.mode(WIFI_AP);
 Serial.print("SSID: ");
 Serial.println(read(200)); 
 Serial.print("password: ");
 Serial.println(read(220)); 
 Serial.println(WiFi.softAP(read(200),read(220)) ? "ready":"FAILED");
 server.on("/", home);
